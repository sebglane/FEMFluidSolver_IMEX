...
computed = np.loadtxt('coeff_comp_8s_re100_CN_final.gz', 
                      usecols=(1,2,3)) 
#==============================================================================
# font settings
...
ax.plot(computed[:,0], computed[:,1], "--", color="black", 
        label =r'\textsc{Crank-Nicolson}-Verfahren')
...
fig1.savefig('plots/drag_coefficients_CN_8000_final.pdf', bbox_inches='tight')
#==============================================================================
...
fig2.savefig('plots/lift_coefficients_CN_8000_final.pdf', bbox_inches='tight')
#==============================================================================
