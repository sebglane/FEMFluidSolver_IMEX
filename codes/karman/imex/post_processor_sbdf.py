...
refDrag = refValues[:,1]    # reference drag coefficients
refLift = refValues[:,2]    # reference lift coefficients
# load computed values
computed = np.loadtxt('coeff_comp_8s_re100_imex_final.gz', 
                      usecols=(1,2,3))
#==============================================================================
...
fig1.savefig('plots/drag_coefficients_sbdf_8000_final.pdf',
             bbox_inches='tight')
#==============================================================================
...
fig2.savefig('plots/lift_coefficients_sbdf_8000_final.pdf',
             bbox_inches='tight')
#==============================================================================
